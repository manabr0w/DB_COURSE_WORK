...
**Час відповіді системи**
  - Система повинна забезпечувати час відповіді на запити користувачів не більше наж 2 секунди .
  - Вимірювання продуктивності повинно виконуватися під час пікового навантаження , коли кількість одночасних запитів досягає    максимуму. 
**Використання ресурсів**
  - Максимальне використання процесора не повинно перевишувати 75% під час навантаження.
  - Система повинна працювати при використанні не більше 70 %  оперативної пам'яті.
**Оптимізація запитів**
  - Запити до бази данних повинні бути оптимізовані , щоб зменшити кількість операцій введення -виведення  і мінімізувати час обробки запиту.
...
**Логування**
 - Система повинна вести детальний журнал всіх операцій , включаючи логування помилок і дій користувачів.
 - Логи повинні бути доступними для вдміністраторів у режимі реального часу.
**Оновлення системи** 
 -  Система повинна пітримувати можливість безперебійного оновлення без зупинки основних функцій.
 -  Оновлення повинні проходити через процес тестування перед розгортанням.
**Документація**
 -  Усі основні компоненти системи повинні мати чітку та зрозумілу документацію , щоб нові члени команди могли легко пітримувати систему та вносити зміни.
